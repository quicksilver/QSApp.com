...
<head>
	...
	<body>
		<center>
			...
			<p style="color:#151515;font-size:20pt;margin-top:-10px;	font-variant: small-caps;">Collated, Finally</p>
			<div class="opener" style="padding-top:40px">
				<p>Hopefully this site will be the 'new' home for Quicksilver and everything that comes with it.<br />The idea is to bring everything that's been happening to Quicksilver since it went open source together in one beautiful, unified place.</p>
				<p>At the moment we have the <a href="plugins">plugins repository</a>, as well as a <a href="wiki">wiki</a>.</p>
				<p>You can <strong>download</strong> Quicksilver from our <a href="https://github.com/quicksilver/Quicksilver/archives/master">Github <img style="border:none;margin-bottom:-2px" src="images/download.png" alt="Download Quicksilver" /></a> page.</p>
