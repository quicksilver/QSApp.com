...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        ...
        <meta content="Learn about Quicksilver, a productivity app for Mac OS X (Lion &amp; Snow Leopard) which gives you the ability to perform common, every-day tasks rapidly and without thought." name="description" />
        <meta name="Keywords" content="Quicksilver, mac, os x, launcher, application, utility, productivity, itunes" />
...
<p style="font-size:110%"><a href="/quicksilverproject.php">Find out</a> about the  Quicksilver Project and the team behind it.
</p>
...
<div class="content">
		<div class="section" id="section1">
					...
					<h2>Find and Do</h3> 
	    			Quicksilver gives you quick access to all your important things. With only a few keystrokes, you can get to your applications, files, contacts, bookmarks, music, etc. Don&#8217;t get distracted though; although Quicksilver finds and launches things quickly and extremely well, it's more about <em>doing</em>, not finding. <br /> 
					<br />
				</div> 
				<?php /*
				<div class="section" id="section2">   			
					...
					<h2>Launch that thing</h3> 
					<p>Want to start Mail.app? Type &#8220;mail&#8221; and press return. Too much typing? Then type &#8220;m&#8221; and select Mail.app from the list of results. Quicksilver learns your abbreviations as you use them. <br />
	    			This isn&#8217;t limited to applications. It applies to anything in Quicksilver&#8217;s catalog: contacts, documents, bookmarks, music and more.</p>				</div>
*/ ?>
				...
				<div class="section" id="section3">
	    			...
	    			<h2>Type it like you think it</h3> 
	    			Using OS X's Spotlight or a similar app to find the contact 'John Smith' requires you to search for say &#8220;john&#8221;. What if you want to just type &#8220;js&#8221;? Quicksilver lets you abbreviate using letters from anywhere in the name, and that means anywhere. Use &#8220;ps&#8221; to find Photoshop or &#8220;tun&#8221; to find iTunes. <br />Use abbreviations that make sense to you.<br /> 
					<br />
				</div> 
...
<br />
	    			...
	    			No thinking. No planning. No adjusting. Just doing. <br /> 
					<br /> 
				</div>
				...
				<div class="section" id="section6">
					...
					<h2>Grab and go</h3> 
	    			Select files or text and act upon them immediately. Quicksilver can grab the current selection from almost any application. Grab selected text to search for it on the web or append it to a file. Grab files and delete them, move them or send them. Grab pictures to resize them or change their format (above), the options are limitless.<br /> 
	    			<br /> 
				</div>
				...
				<div class="section" id="section7">
	    			...
	    			<h2>Keep Finder at arm&#8217;s length</h3> 
	    			Quicksilver allows you to do all sorts of things with files: move, copy, rename, delete, whilst also letting you navigate your entire file system. Just add a few important top-level folders to the catalog and you can browse through your folders from there.<br /> 
					<br /> 
				</div>
				...
				<div class="section" id="section8">
					...
					<h2>Still not fast enough?</h3> 
	    			If you find yourself doing something frequently, you can <strong>speed up the task</strong> even further by assigning a &#8220;trigger&#8221; to it. Triggers give you the power to assign regular tasks to keyboard shortcuts or mouse movements; you don't even need to activate Quicksilver.<br /> 
					<br /> 
				</div>
				...
				<div class="section" id="section9">
					 ...
					 <h2>Extend Quicksilver &amp; do more</h3> 
...
<?php /* 			<a href="#section11" id="control11"></a> */ ?>
		</div>
	<script type="text/javascript" charset="utf-8">
		var glider = new Glider('about_glider', {duration:0.5});
				...
				<div class="Page-Break"></div>
				<div class="Feature">
    				<h2>What about Spotlight for Mac OS X?</h3> 
				<a name="spotlight"></a>
...
<div style="text-align:right;margin-top:-10px">Anonymous</div>
</p>
<p>
