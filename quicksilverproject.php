...
<br />3 years later, in November 2006, the project was released to the open source world.
</p>
...
<p>
Following this, Quicksilver had a shaky few years, with its future looking bleak. Several developers fixed a few bugs between 2007 &#150; 2010, but nothing major was achieved.</p>
...
<p>Quicksilver is maintained by a small group of devoted volunteers. People come and go, as with any open source project, but the main core are those shown below.
	</p>
		...
		<div class="Feature">
			...
			<p>Patrick is a freelance developer, who develops mobile apps, OS X apps and web apps. He first contributed to the Quicksilver Project in June 2008.
				...
				<p>Today, in and out of his freelance developing, he juggles between writing code for Quicksilver, managing QSApp.com,
					 creating press and urging others to join the Quicksilver band-wagon.
					<p>
	...
	<p>There are many other notable contributors to the Quicksilver Project.</p>
		<ul>
			...
			<li>Jon Stovell and Howard Melman are known for helping users in the <a href="http://groups.google.com/group/blacktree-quicksilver/topics?gvc=2">support forums</a>.</li>
			<li><a href="http://strandeddesign.com">Dan Deming-Henes</a> made this beautiful site, as well as some new icons for Quicksilver.</li>
